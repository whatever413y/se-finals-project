...
const Admin: React.FC = () => {
  ...
  const handleUserDelete = async (event: FormEvent<HTMLFormElement>) => {
    ...
    await Axios.post('https://se-finals-project-production.up.railway.app/user/delete', input).then((response) => {
  ...
  const handleBookAdd = async (event: FormEvent<HTMLFormElement>) => {
    ...
    await Axios.post('https://se-finals-project-production.up.railway.app/book/add', input).then((response) => {
      if (response.data === "fail") {
  ...
  const handleBookDelete = async (event: FormEvent<HTMLFormElement>) => {
    ...
    await Axios.post('https://se-finals-project-production.up.railway.app/book/delete', input).then((response) => {
      if (response.data === "fail") {
